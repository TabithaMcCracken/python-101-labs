...
# Split the string into a list of all the winds
# Create a new list
# Rearrange and add the necessary letters to each word and put them into a new list
# Display new string

sentence = """
You would never guess what can happen when you jump into a seemingly shallow puddle at night time! It turns out that it is not a puddle rather than a giant hole which brings you to a new world on the other side of the light water.
